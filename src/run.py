...
class Run:
    """Wrapper around run data that implements some nice getter functions and opens up the path for caching stuff. Similar to Player."""
    ...
    def get_link(self):
        """Returns a link to the video submission, or to the SRC weblink if it doesn't exist."""
